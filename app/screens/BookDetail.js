...
async componentWillMount() {
  ...
  const res = await fetch("http://skunkworks.ignitesol.com:8000/books/?topic=" + this.props.navigation.state.params.name);
...
async fetchSearchedBooks(){
  const res = await fetch("http://skunkworks.ignitesol.com:8000/books?search=" +this.props.navigation.state.params.searchedBooks);
  const result = await res.json();
